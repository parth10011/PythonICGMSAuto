...
def test_PreInsp_CustFormFill():
    ...
    # Open View Details
    view_details = wait.until(EC.element_to_be_clickable((By.XPATH, "(//tr[td[text()='Motor Pre Inspection'] and td/span[text()='Claim Initiated']]//button[text() = 'View Details'])[1]")))
    view_details.click()
    time.sleep(1)
