...
driver.find_element(By.XPATH, "//input[contains(@formcontrolname, 'customer_email')]").send_keys("ahd@jja.caa")
...
driver.find_element(By.XPATH, "//input[contains(@placeholder,'Enter Customer Name')]").send_keys("randomCustName")
driver.find_element(By.XPATH, "//input[contains(@placeholder,'Enter Repairer Name')]").send_keys("randomRepairName")
driver.find_element(By.XPATH, "//input[contains(@placeholder,'Enter Make')]").send_keys("Check")
driver.find_element(By.XPATH, "//input[contains(@placeholder,'Enter Model')]").send_keys("Email Veri")
driver.find_element(By.XPATH, "//input[contains(@placeholder,'Enter Type')]").send_keys("fication")
...
driver.find_element(By.XPATH, "//input[contains(@placeholder,'Enter Year of Mfg')]").send_keys("3222")
ToasterPopupClick()
